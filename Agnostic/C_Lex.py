...
tokens = (
    ...
    'INC_OP', 'DEC_OP', 'LEFT_OP', 'RIGHT_OP', 'LE_OP', 'DO',
...
all_const_exp = r'('+const_exp1 + r')|(' + const_exp2 + r')|(' + \
    const_exp3 + r')|('+const_exp4+r')|('+const_exp5+r')|('+const_exp6+')'
